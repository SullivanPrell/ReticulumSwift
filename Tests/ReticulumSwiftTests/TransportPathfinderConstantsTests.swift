...
final class TransportPathfinderConstantsTests: XCTestCase {
  ...
  func testPropagationLimitDefaultsToPathfinderM() {
    let t = Transport()
    XCTAssertEqual(
      t.propagationLimit, UInt8(Transport.pathfinderM),
