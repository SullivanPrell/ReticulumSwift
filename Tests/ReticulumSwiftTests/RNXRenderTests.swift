...
final class RNXRenderTests: XCTestCase {
  ...
  private func metrics(
    ...
    concludedAfter: TimeInterval? = nil
  ...
  func testDetailedTrailer() {
    ...
    XCTAssertEqual(
      rendered.trailer.components(separatedBy: "\n"),
      [
        "",
  ...
  func testRnxPrettyTimeComponents() {
    ...
    XCTAssertEqual(
      RNXResultRenderer.rnxPrettyTime(days + hours + minutes + seconds),
      "3d, 4h, 5m and 6.25s")
