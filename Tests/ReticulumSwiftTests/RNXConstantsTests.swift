...
final class RNXConstantsTests: XCTestCase {
  ...
  func testFileNames() {
    ...
    XCTAssertEqual(
      RNXApp.allowedIdentitiesSearchPaths,
  ...
  func testLogLevelClamp() {
    // Python clamps the requested loglevel to [LOG_CRITICAL, LOG_EXTREME]—Reticulum.py:301-302.
    // -qqqq lands on 0, and can never reach LOG_NONE (-1).
