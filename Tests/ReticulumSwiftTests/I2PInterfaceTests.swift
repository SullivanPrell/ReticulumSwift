...
final class I2PInterfaceConstantsTests: XCTestCase {
  ...
  func testBitrateGuess() {
    XCTAssertEqual(
      I2PInterface.bitrateGuess, 256_000,
      "Python: BITRATE_GUESS = 256*1000")
  }

  func testDefaultIfacSize() {
    XCTAssertEqual(
      I2PInterface.defaultIfacSize, 16,
      "Python: DEFAULT_IFAC_SIZE = 16")
  }

  func testHwMtu() {
    XCTAssertEqual(
      I2PInterface.hwMtu, 1064,
...
final class I2PInterfacePeerConstantsTests: XCTestCase {
  ...
  func testReconnectWait() {
    XCTAssertEqual(
      I2PInterfacePeer.reconnectWait, 15,
      "Python: RECONNECT_WAIT = 15")
  }

  func testReconnectMaxTriesIsNil() {
    XCTAssertNil(
      I2PInterfacePeer.reconnectMaxTries,
      "Python: RECONNECT_MAX_TRIES = None (unlimited)")
  }

  func testI2PUserTimeout() {
    XCTAssertEqual(
      I2PInterfacePeer.i2pUserTimeout, 45,
      "Python: I2P_USER_TIMEOUT = 45")
  }

  func testI2PProbeAfter() {
    XCTAssertEqual(
      I2PInterfacePeer.i2pProbeAfter, 10,
      "Python: I2P_PROBE_AFTER = 10")
  }

  func testI2PProbeInterval() {
    XCTAssertEqual(
      I2PInterfacePeer.i2pProbeInterval, 9,
      "Python: I2P_PROBE_INTERVAL = 9")
  }

  func testI2PProbes() {
    XCTAssertEqual(
      I2PInterfacePeer.i2pProbes, 5,
      "Python: I2P_PROBES = 5")
  }

  func testI2PReadTimeout() {
    let expected =
      (I2PInterfacePeer.i2pProbeInterval * I2PInterfacePeer.i2pProbes
        + I2PInterfacePeer.i2pProbeAfter) * 2
    XCTAssertEqual(
      I2PInterfacePeer.i2pReadTimeout, expected,
      "Python: I2P_READ_TIMEOUT = (PROBE_INTERVAL*PROBES + PROBE_AFTER)*2")
  }

  func testTunnelStateValues() {
    XCTAssertEqual(
      I2PInterfacePeer.TunnelState.initializing.rawValue, 0x00,
      "Python: TUNNEL_STATE_INIT = 0x00")
    XCTAssertEqual(
      I2PInterfacePeer.TunnelState.active.rawValue, 0x01,
      "Python: TUNNEL_STATE_ACTIVE = 0x01")
    XCTAssertEqual(
      I2PInterfacePeer.TunnelState.stale.rawValue, 0x02,
...
final class I2PInterfaceInitTests: XCTestCase {
  ...
  func testInterfaceStartsOffline() {
    let daemon = MockI2PDaemon()
    let iface = I2PInterface(
      name: "TestI2P", daemon: daemon,
