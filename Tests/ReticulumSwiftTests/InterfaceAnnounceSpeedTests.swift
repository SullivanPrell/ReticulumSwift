...
final class InterfaceAnnounceSpeedTests: XCTestCase {
  ...
  func testAnnounceSpeedIsTheDerivativeOfTheAnnounceByteTotal() {
    ...
    XCTAssertEqual(
      t.currentAnnounceRxSpeed(for: iface), 0,
    ...
    XCTAssertEqual(
      t.currentAnnounceRxSpeed(for: iface), 200, accuracy: 0.001,
  ...
  func testAQuietIntervalReportsZeroRatherThanTheLastRate() {
    ...
    XCTAssertEqual(
      t.currentAnnounceRxSpeed(for: iface), 0, accuracy: 0.001,
      """
