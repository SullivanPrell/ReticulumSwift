...
final class IFACTests: XCTestCase {
  ...
  private func makePacket(
    destinationHash: Data = Data(repeating: 0xAB, count: Constants.truncatedHashLength)
  ) -> Packet {
    Packet(
  ...
  func testIfacCodeMatchesPython() throws {
    ...
    let expectedSeed = Data(bytes: [
      0x17, 0x08, 0xd9, 0x4b, 0xd0, 0xee, 0xaf, 0x7c, 0x57, 0xcb, 0x9b, 0x85, 0x62, 0xa6, 0xf1,
      0xd9,
      0xb0, 0x16, 0xa4, 0x31, 0xf3, 0x92, 0x3c, 0x13, 0x7b, 0x57, 0x26, 0x0c, 0xc8, 0xfc, 0xbe,
      0xc7,
    ])
    ...
    XCTAssertEqual(
      Data(ifacKey.suffix(32)), expectedSeed,
    ...
    XCTAssertEqual(
      swiftIfacCode, expectedIfacCode,
