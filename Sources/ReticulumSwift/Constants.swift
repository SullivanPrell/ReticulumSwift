...
public enum Constants {
  ...
  public static let encryptedMdu: Int =
    (mdu - tokenOverhead - halfKeySize) / aes128BlockSize * aes128BlockSize - 1
  ...
  public static let linkMdu: Int =
    (mtu - ifacMinSize - headerMinSize - tokenOverhead) / aes128BlockSize * aes128BlockSize - 1
