...
extension RNCopyApp {
  ...
  public static let fetchRequestPath: String = "fetch_file"

  /// Wire key for the fetch handler: `truncated_hash(b"fetch_file")`.
  ///
  /// Equals `4ce505754cbdc8c2c8775a3006a712f0`.
  public static var fetchRequestPathHash: Data { Hashes.truncatedHash(Data(fetchRequestPath.utf8)) }
  ...
  public static let receiveAspect: String = "receive"
  ...
  public static let identityFileName: String = appName

  /// Name of the on-disk allow-list.
  ///
  /// Python: `allowed_file_name` (rncp.py:124).
  public static let allowedIdentitiesFileName: String = "allowed_identities"
  ...
  public static let endSpace: String = " "

  /// Ordered candidate locations of the allow-list file; first hit wins.
  ///
  /// Python: rncp.py:126-131.
  public static func allowedIdentitiesSearchPaths(home: String) -> [String] {
    [
...
extension RNCopyApp {
  ...
  public static func sizeStr(_ num: Double, suffix: String = "B") -> String {
    UtilityFormatting.sizeStr(num, suffix: suffix)
  }

  /// `Int` convenience overload.
  public static func sizeStr(_ num: Int, suffix: String = "B") -> String {
  ...
  public static func speedStr(_ bytesPerSecond: Double) -> String {
  ...
  public static func transferStat(
    progress: Double,
    totalSize: Int,
    speed: Double,
    phySpeed: Double? = nil,
...
extension RNCopyApp {
  ...
  public static func expandUser(_ path: String, home: String) -> String {
  ...
  public static func absolutePath(_ path: String, cwd: String) -> String {
    var joined = path
    if !joined.hasPrefix("/") {
...
extension RNCopyApp {
  ...
  public static func encodeMetadata(name: String) -> Data {
  ...
  public static func decodeMetadataName(_ packed: Data) -> String? {
...
extension RNCopyApp {
  ...
  public static func parseAllowedIdentitiesFile(_ contents: String) -> [String] {
    contents
  ...
  public enum AllowedIdentityError: Swift.Error, Equatable, CustomStringConvertible {
    ...
    public var message: String {
      ...
      case .invalidLength:
        return
          "Allowed destination length is invalid, must be \(RNCopyApp.destinationHexLength) hexadecimal characters (\(RNCopyApp.destinationHexLength / 2) bytes)."
      case .invalidHex:
  ...
  public static func decodeAllowedIdentity(_ hex: String) throws -> Data {
  ...
  public struct AllowedIdentitiesLoad: Equatable {
    ...
    public var logMessage: String? {
      ...
      return
        "Loaded \(fileEntryCount) allowed identit\(fileEntryCount == 1 ? "y" : "ies") from \(sourcePath)"
    }
  }
  ...
  public static func loadAllowedIdentities(
    commandLineEntries: [String],
    fileSystem: RNCopyFileSystem
  ) -> AllowedIdentitiesLoad {
    ...
    guard let path = candidates.first(where: { fileSystem.fileExists(atPath: $0) }) else {
      return AllowedIdentitiesLoad(
        merged: commandLineEntries, fileEntryCount: 0,
    ...
    do {
      ...
      return AllowedIdentitiesLoad(
        merged: merged, fileEntryCount: fromFile.count,
  ...
  /// `print()` before `exit(1)`.
  public static func decodeDestinationArgument(_ hex: String) throws -> Data {
...
extension RNCopyApp {
  ...
  /// else-branch.
  public static func classifyFetchResponse(_ payload: Data) -> RNCopyFetchStatus {
...
extension RNCopyApp {
  ...
  /// process can read.
  public static func resolveFetchPath(
    requested: String,
    jail: String?,
    fileSystem: RNCopyFileSystem
  ) -> RNCopyFetchResolution {
...
extension RNCopyApp {
  ...
  public static func resolveSaveTarget(
    filename: String,
    savePath: String?,
    allowOverwrite: Bool,
    fileSystem: RNCopyFileSystem,
    onOverwriteFailure: ((String) -> Void)? = nil
  ) -> RNCopySaveResolution {
    let savedFilename: String
    if let savePath {
      savedFilename = absolutePath(
        expandUser(
          savePath + "/" + filename,
...
extension RNCopyApp {
  ...
  public static func resolveSaveDirectory(
    _ save: String,
    fileSystem: RNCopyFileSystem
  ) -> RNCopySaveDirectory {
    let path = absolutePath(
      expandUser(save, home: fileSystem.homeDirectoryPath),
      cwd: fileSystem.currentDirectoryPath)
...
extension RNCopyApp {
  ...
  public enum IdentityError: Swift.Error, Equatable, CustomStringConvertible {
    ...
    public var message: String {
      ...
      case .corruptIdentityFile(let path):
        return
          "Could not load identity for rncp. The identity file at \"\(path)\" may be corrupt or unreadable."
      }
    }
  ...
  public static func defaultIdentityPath(storagePath: URL) -> URL {
  ...
  public static func prepareIdentity(at url: URL) throws -> Identity {
  ...
  public static func prepareIdentity(storagePath: URL) throws -> Identity {
...
extension RNCopyApp {
  ...
  ///
  /// Python: rncp.py:796.
  public static let overview: String = "Reticulum File Transfer Utility"
  ...
  public static func makeArgumentParser() -> ArgumentParser {
    ...
    parser.option(
      ["-w"], metavar: "seconds", help: "sender timeout before giving up",
  ...
  public static func collectRepeatedOption(_ name: String, in arguments: [String]) -> [String] {
    var values: [String] = []
    var index = 0
...
extension RNCopyApp {
  ...
  public static func logLevel(verbosity: Int, quietness: Int) -> Reticulum.LogLevel {
