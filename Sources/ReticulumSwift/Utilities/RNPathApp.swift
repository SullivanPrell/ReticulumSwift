...
public enum RNPathApp {
  ...
  public enum ParseError: Error, Equatable, CustomStringConvertible {
    ...
    public var message: String {
      ...
      case .invalidHashLength:
        // Python: rnpath.py:95
        return
          "Hash length is invalid, must be \(RNPathApp.hexHashLength) hexadecimal characters (\(Constants.truncatedHashLength) bytes)."
      case .invalidHash:
        // Python: rnpath.py:99
      ...
      case .invalidDestinationLength:
        ...
        return
          "Destination length is invalid, must be \(RNPathApp.hexHashLength) hexadecimal characters (\(Constants.truncatedHashLength) bytes)."
      case .invalidDestination:
  ...
  private static func decodeHash(
    _ input: String,
