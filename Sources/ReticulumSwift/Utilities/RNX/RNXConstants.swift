...
extension RNXApp {
  ...
  public static let identityFileName: String = "rnx"
  ...
  public static let allowedIdentitiesSearchPaths: [String] = [
  ...
  public static let remoteExecGrace: TimeInterval = 2.0
  ...
  public static let rexecRttFactor: Double = 4.0
  ...
  public static let destinationHexLength: Int = 32
  ...
  public static let statClearWidth: Int = 82
  ...
  public enum Result: UInt8, Equatable, CaseIterable {
    ...
    /// The destination argument wasn't 32 hex characters. rnx.py:339.
    case invalidDestination = 241
    /// No path to the listener within `-w` seconds. rnx.py:352.
    case pathNotFound = 242
    /// The link couldn't be established within `-w` seconds. rnx.py:370.
    case linkFailed = 243
    ...
    /// The 8-element response couldn't be destructured. rnx.py:457.
