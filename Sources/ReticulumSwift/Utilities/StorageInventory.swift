...
public enum StorageInventory {
  ...
  public static func url(_ entry: Entry, storage storagePath: URL) -> URL {
    precondition(
      entry.components.first == Entry.storage.relativePath,
...
extension StorageInventory.Entry {
  ...
  public static let config = StorageInventory.Entry(
    ["config"], .file,
  ...
  public static let storage = StorageInventory.Entry(
    ["storage"], .directory,
  ...
  public static let interfaceModules = StorageInventory.Entry(
  ...
  public static let identity = StorageInventory.Entry(
  ...
  public static let transportIdentity = StorageInventory.Entry(
  ...
  public static let ratchets = StorageInventory.Entry(
  ...
  public static let identityRatchets = StorageInventory.Entry(
    ["storage", "identity.ratchets"], .file,
    authority: .portOnly(
      reason: "the local identity's own ratchets; the reference has no "
  ...
  public static let knownDestinations = StorageInventory.Entry(
  ...
  public static let destinationTable = StorageInventory.Entry(
  ...
  public static let tunnels = StorageInventory.Entry(
  ...
  public static let packetHashlist = StorageInventory.Entry(
  ...
  public static let cache = StorageInventory.Entry(
  ...
  public static let announceCache = StorageInventory.Entry(
  ...
  public static let resources = StorageInventory.Entry(
  ...
  public static let identities = StorageInventory.Entry(
  ...
  public static let blackhole = StorageInventory.Entry(
  ...
  public static let blackholeLocal = StorageInventory.Entry(
  ...
  public static let blackholeLocalTemp = StorageInventory.Entry(
  ...
  /// creates both levels.
  public static let discovery = StorageInventory.Entry(
  ...
  public static let discoveredInterfaces = StorageInventory.Entry(
  ...
  public static let i2p = StorageInventory.Entry(
