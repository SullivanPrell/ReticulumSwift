...
public enum RNSDApp {
  ...
  public static let rnpkgExampleConfig: String =
  ...
  struct OptionSpec {
    ...
    var takesValue: Bool {
      if case .value = kind { return true }
      return false
    }
  ...
  static func optionSpecs(_ variant: Variant) -> [OptionSpec] {
    var specs: [OptionSpec] = [
      OptionSpec(
        names: ["-h", "--help"], kind: .flag,
        help: "show this help message and exit"),
      OptionSpec(
        names: ["--config"], kind: .value(metavar: "CONFIG"),
