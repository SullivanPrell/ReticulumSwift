...
public enum RNIDCommandLine {
  ...
  public static func makeParser() -> ArgumentParser {
    ...
    parser.optionalValue(
      ["-a", "--announce"], metavar: "aspects", const: RNIDApp.defaultAspects,
      help: "announce a destination based on this Identity")
    parser.option(
      ["-H", "--hash"], metavar: "aspects",
    ...
    parser.option(
      ["-t"], metavar: "seconds", help: "identity request timeout before giving up",
  ...
  public static func parse(_ arguments: [String]) throws -> Invocation {
    ...
    invocation.embedMetaWithoutPath =
      parsed.wasProvided("--embed-meta")
