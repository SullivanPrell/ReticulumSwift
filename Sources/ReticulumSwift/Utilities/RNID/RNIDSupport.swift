...
extension RNIDApp {
  ...
  public static func outputFormat(base32: Bool, base64: Bool, base256: Bool, hex: Bool)
    -> OutputFormat
  {
...
extension RNIDApp {
  ...
  public static let rsgAsciiHeader: String = "#### Start of rsg data "
  /// Python: `RSG_ASCII_FOOTER = b" End of rsg data ####"` (rnid.py:519).
  public static let rsgAsciiFooter: String = " End of rsg data ####"
  /// Python: `RSG_ASCII_ROW_WIDTH = 64` (rnid.py:520).
  public static let rsgAsciiRowWidth: Int = 64
  /// Python: `RSG_PADDING = b"="` (rnid.py:521).
  public static let rsgPadding: Character = "="
}
...
extension RNIDApp {
  ...
  public static func splitAspects(_ dotted: String) -> [String] {
...
public enum RNIDDestinationHash {
  ...
  public static func hash(fromFullName fullName: String, identityHash: Data) -> Data? {
    ...
    return hash(
      identityHash: identityHash, appName: appName, aspects: Array(components.dropFirst()))
  }
}
...
extension RNIDApp {
  ...
  public enum ArgumentValidation: Equatable {
    case ok
  ...
  public static func validateArguments(
    ...
    var ops = 0
    for present in [
      truthy(encrypt), truthy(decrypt), truthy(validate), truthy(sign), signMessageTruthy,
    ]
    where present { ops += 1 }
    if ops > 1 {
      // Python: rnid.py:90.
    ...
    var group = 0
    for present in [
      truthy(importPublic), truthy(importPrivate), truthy(identity), truthy(generate),
    ]
