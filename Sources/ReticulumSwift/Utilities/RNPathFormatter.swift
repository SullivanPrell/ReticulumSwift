...
public enum RNPathFormatter {
  ...
  public static func blackholeLine(
    _ entry: RNPathBlackholeEntry,
    now: TimeInterval,
    localTransportIdentityHash: Data?
  ) -> String {
  ...
  public static func blackholeFilterString(
    _ entry: RNPathBlackholeEntry,
    now: TimeInterval,
    localTransportIdentityHash: Data?
  ) -> String {
  ...
  public static func pathFoundLine(
