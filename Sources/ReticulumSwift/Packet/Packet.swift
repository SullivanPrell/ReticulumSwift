...
public struct Packet: Equatable {
  ...
  public static func == (lhs: Packet, rhs: Packet) -> Bool {
    lhs.headerType == rhs.headerType && lhs.contextFlag == rhs.contextFlag
      && lhs.transportType == rhs.transportType && lhs.destinationType == rhs.destinationType
      && lhs.packetType == rhs.packetType && lhs.hops == rhs.hops
      && lhs.transportID == rhs.transportID && lhs.destinationHash == rhs.destinationHash
      && lhs.context == rhs.context && lhs.data == rhs.data
  }
}
