...
public enum InterfaceMode: UInt8, Sendable, Equatable {
  ...
  public static let discoverPathsFor: Set<InterfaceMode> = [
    .accessPoint, .gateway, .roaming, .internal,
  ]
...
extension Interface {
  ...
  public func optimiseMtu() {
    ...
    guard let mutable = self as? MtuAutoconfiguringInterface else {
      ...
      Reticulum.log(
        "\(displayName) claims autoconfigureMtu but has no settable hwMtu — "
    ...
    Reticulum.log(
      "\(displayName) hardware MTU set to \(String(describing: mutable.hwMtu))",
      level: .pathing)
  }
  ...
  public var displayName: String { "\(statsTypeName)[\(name)]" }
  ...
  public func getMode() -> InterfaceMode { mode }

  public var rxBytes: Int { 0 }
  public var txBytes: Int { 0 }
  public var rxPackets: Int { 0 }
  public var txPackets: Int { 0 }

  // HW MTU—unknown by default
  public var hwMtu: Int? { nil }
  public var autoconfigureMtu: Bool { false }
  public var fixedMtu: Bool { false }
  ...
  public var supportsDiscovery: Bool { false }
  ...
  public var discoveryListenPort: Int? { nil }
  public var discoveryEndpointAddress: String? { nil }
  public var discoveryRadioParameters: DiscoveryRadioParameters? { nil }

  public var isRoutingEndpoint: Bool { true }

  // PHY stats—no radio hardware by default
  public var rssi: Float? { nil }
  public var snr: Float? { nil }
  ...
  ///   [S+2..]    raw[2..] ^ mask[S+2..]
  public func wrapIfac(_ raw: Data) -> Data {
  ...
  public func unwrapIfac(_ raw: Data) -> Data? {
